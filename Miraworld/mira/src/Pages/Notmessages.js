        ...
        <div className='settings-cont'>
            ...
            <div className='set-mid'>
                ...
                <div className='not-links'>
                    <Link to={'/Miraworld/Notmessages'}><p className='not-link active-link'>Notification Messages 2</p></Link>
                    <Link to={'/Miraworld/Notpreference'}><p className='not-link'>Notification Preferences</p></Link>
                </div>
                ...
                <div className='nots'>
                    <div className='not'>
                        ...
                        <div className='not-info'>
                            <h6>New Messages</h6>
                            <p><span>Jenny Sandra</span> sent you a message in your chats</p>
