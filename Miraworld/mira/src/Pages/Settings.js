        ...
        <div className='settings-cont'>
            ...
            <div className='set-mid'>
                ...
                <div className='set-links'>
                    <Link to={'/Miraworld/Settings'}><p className='set-link active-link'>General</p></Link>
                    <Link to={'/Miraworld/Notmessages'}><p className='set-link'>Notifications</p></Link>
                ...
                <div className='set-bottom'>
                        ...
                        <div className='personal'>
                            ...
                            <p>You can change your personal information whenever you wish to.</p>
                        </div>
                        ...
                        <div className='bio'>
                                <small>Bio</small>
                                <p>Hi there! i'm Jordan, a dedicated online shopper and lifestyle
                                    enthusiast from Austin, Texas. I have a passion for finding the best Products that enhance my evryday life from cutting
                                    from cutting edge gadgets to carry home decor and stylish fashion pieces.
                                </p>
                            </div>
                    </div>
            </div>
