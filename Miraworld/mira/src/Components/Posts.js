        ...
        <div className="Posts">
          ...
          <div className="post">
            ...
            <div className="post-img">
              <p>
                Hello world, I'm Chris Scott from USA and I am so happy to be a
                user of Mira. Thanks to the developers.
              </p>
            ...
            <div className="action-button">
              <div className="interaction-button">
                ...
                <p>1.8k</p>
                <span onClick={() => handleCommentClick(S1)}>
          ...
          <div className="post">
            ...
            <div className="action-button">
              <div className="interaction-button">
                ...
                <p>1.8k</p>
                <span onClick={() => handleCommentClick(S3)}>
                  <img src={Messages} alt="message" />
                </span>
                <p>1.8k</p>
              </div>
          ...
          <div className="post">
            ...
            <div className="action-button">
              <div className="interaction-button">
                ...
                <p>1.8k</p>
                <span onClick={() => handleCommentClick(S5)}>
                  <img src={Messages} alt="message" />
                </span>
                <p>1.8k</p>
              </div>
          ...
          <div className="post">
            ...
            <div className="action-button">
              <div className="interaction-button">
                ...
                <p>1.8k</p>
                <span onClick={() => handleCommentClick(S7)}>
                  <img src={Messages} alt="message" />
                </span>
                <p>1.8k</p>
              </div>
          ...
          <div className="post">
            ...
            <div className="action-button">
              <div className="interaction-button">
                ...
                <p>1.8k</p>
                <span onClick={() => handleCommentClick(S6)}>
                  <img src={Messages} alt="message" />
                </span>
                <p>1.8k</p>
              </div>
          ...
          <div className="post">
            ...
            <div className="action-button">
              <div className="interaction-button">
                ...
                <p>1.8k</p>
                <span onClick={() => handleCommentClick(S2)}>
                  <img src={Messages} alt="message" />
                </span>
                <p>1.8k</p>
              </div>
