...
const Reel = () => {
  ...
  const displayedItems =
    activeTab === "topSelling" ? topSellingItems : topStores;

  return (
    <div className="Reels">
      <div className="heads">
        <div
          className={`title ${activeTab === "topSelling" ? "active-title" : ""}`}
          onClick={() => setActiveTab("topSelling")}
        >
          <h1>Top Selling Items</h1>
        </div>
        <div
          className={`title2 ${activeTab === "topStores" ? "active-title" : ""}`}
          onClick={() => setActiveTab("topStores")}
        >
          <h1>Top Stores</h1>
        </div>
      </div>
