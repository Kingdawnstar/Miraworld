    ...
    <div className="side-bar">
      ...
      <div className="shortcut-links">
        <Link to={"/Miraworld"}>
          <div
            className={
              location.pathname === "/Miraworld"
                ? "side-link active"
                : "side-link" && location.pathname === "/Miraworld/"
                  ? "side-link active"
                  : "side-link"
            }
          >
            <img
              className={
                location.pathname === "/Miraworld"
                  ? ""
                  : "first" && location.pathname === "/Miraworld/"
                    ? ""
                    : "first"
              }
              src={Home}
        ...
        <Link to={"/Miraworld/Products"}>
          <div
            className={
              location.pathname === "/Miraworld/Products"
                ? "side-link active"
                : "side-link" &&
                    location.pathname === "/Miraworld/Productdetpage"
                  ? "side-link active"
                  : "side-link" &&
                      location.pathname === "/Miraworld/Paydetailspg"
                    ? "side-link active"
                    : "side-link"
            }
          >
        ...
        <Link to={"/Miraworld/Shoppingcart"}>
          <div
            className={
              location.pathname === "/Miraworld/Shoppingcart"
                ? "side-link active"
                : "side-link"
            }
          >
            <img className="inv" src={Cart} alt="" />
            <p>Shopping Cart</p>
          </div>
        </Link>
        <Link to={"/Miraworld/Order"}>
          <div
            className={
              location.pathname === "/Miraworld/Order"
                ? "side-link active"
                : "side-link" && location.pathname === "/Miraworld/Myorders"
                  ? "side-link active"
                  : "side-link"
            }
          >
        ...
        <Link to={"/Miraworld/Productswish"}>
          ...
          >
            <img className="inv" src={Wish} alt="" />
            <p>My Wishlist</p>
          </div>
        </Link>
        <Link to={"/Miraworld/Featuredvideos"}>
          <div
            className={
              location.pathname === "/Miraworld/Featuredvideos"
                ? "side-link active"
                : "side-link"
            }
          >
            <img className="inv" src={Video} alt="vid" />
            <p>Featured Videos</p>
          </div>
        </Link>
        ...
        <Link to={"/Miraworld/Chats"}>
          <div
            className={
              location.pathname === "/Miraworld/Chats"
                ? "side-link active"
                : "side-link"
            }
          >
            <img className="inv" src={Chat} alt="" />
            <p>Chat</p>
          </div>
        </Link>
        ...
        <Link to={"/Miraworld/Settings"}>
          <div
            className={
              location.pathname === "/Miraworld/Settings"
                ? "side-link active"
                : "side-link" &&
                    location.pathname === "/Miraworld/Notpreference"
                  ? "side-link active"
                  : "side-link" &&
                      location.pathname === "/Miraworld/Notmessages"
                    ? "side-link active"
                    : "side-link"
            }
          >
            <img className="inv" src={Setting} alt="" />
            <p>Settings</p>
          </div>
        </Link>
