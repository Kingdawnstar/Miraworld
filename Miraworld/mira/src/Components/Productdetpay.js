  ...
  return (
    <div className='Productdetpay'>
        <div className='top-side'>
            ...
            <div className='price'>
            <p>$39.00<span><del>$50.00</del></span></p>
        ...
        <div className='load'>
        <p>only <b>9</b> items left in stock!</p>
        <img className='loader' src={loader} alt=''/>
        </div>
       <div className='size-session'>
            <p className='size'><b>Size:</b><span>M</span></p>
      ...
      <Link to = {'/Miraworld/Paydetailspg'}><div className='buy'>
        <p>Buy now</p>
        </div>
        </Link>
        <div className='act'>
        ...
        <div className='deliver'>
            <div className='est-del'>
                <img src={Tr} alt=''/>
                <p><b>Estimated Delivery:</b> Jul 30 - Aug 03</p>
            </div>
            <div className='ship'>
                <img src={pack} alt=''/>
                <p><b>Free Shipping & Returns: </b>On all orders over $75</p>
            </div>
